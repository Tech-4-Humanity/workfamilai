            ...
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div className="relative">
                ...
                <img
                  src={imageUrl}
                  alt={leader.name}
                  className="relative w-16 h-16 rounded-xl object-cover border-2 border-white/30 shadow-lg"
                  onError={(e) => {
                ...
                />
                <div 
                  className={`hidden w-16 h-16 ${leader.color} rounded-xl items-center justify-center text-white text-2xl font-bold border-2 border-white/30 shadow-lg`}
                >
                  {leader.avatar}
                </div>
              </div>
      ...
      <CardContent className="relative z-10">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>{leader.agentCount} AI Agents</span>
          </div>
          <Button 
            variant="outline" 
            size="sm" 
