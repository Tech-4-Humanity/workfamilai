...
import { Brain, Zap, Users, Target, Sparkles } from 'lucide-react';
...
const familyMembers: FamilyMember[] = [
  { id: 'amara-chen', name: 'Dr. Amara Chen', title: 'Product Development', color: 'from-blue-400 to-blue-600', x: 20, y: 30, pulseDelay: 0 },
  { id: 'marcus-bennett', name: 'Marcus Bennett', title: 'Governance & Compliance', color: 'from-gray-500 to-gray-700', x: 15, y: 45, pulseDelay: 0.2 },
  { id: 'aisha-al-farsi', name: 'Aisha Al-Farsi', title: 'External Relations', color: 'from-pink-400 to-pink-600', x: 85, y: 45, pulseDelay: 0.4 },
  { id: 'miguel-santos', name: 'Miguel Santos', title: 'Marketing', color: 'from-green-400 to-green-600', x: 80, y: 30, pulseDelay: 0.6 },
  { id: 'priya-sharma', name: 'Priya Sharma', title: 'Human Resources', color: 'from-purple-400 to-purple-600', x: 10, y: 60, pulseDelay: 0.8 },
  { id: 'theo-williams', name: 'Theo Williams', title: 'Finance & Operations', color: 'from-orange-400 to-orange-600', x: 50, y: 50, pulseDelay: 1.0 },
  { id: 'yuna-kim', name: 'Dr. Yuna Kim', title: 'Customer Support', color: 'from-teal-400 to-teal-600', x: 90, y: 60, pulseDelay: 1.2 },
  { id: 'david-okafor', name: 'David Okafor', title: 'Innovation & R&D', color: 'from-indigo-400 to-indigo-600', x: 30, y: 80, pulseDelay: 1.4 },
  { id: 'sofia-rodriguez', name: 'Sofia Rodriguez', title: 'Sales', color: 'from-red-400 to-red-600', x: 70, y: 80, pulseDelay: 1.6 }
];
    ...
    <Card className="w-full overflow-hidden relative bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900 text-white border-none shadow-2xl">
      ...
      <CardHeader className="text-center pb-4 relative z-10">
        ...
        <Badge variant="outline" className="border-cyan-400/50 text-cyan-300 bg-cyan-400/10 backdrop-blur-sm mx-auto px-4 py-1">
          Our Family Home • Nine Minds, One Mission
        </Badge>
      </CardHeader>
      ...
      <CardContent className="relative z-10">
        ...
        <div className="relative h-96 mb-8 bg-gradient-to-br from-black/30 to-blue-900/30 rounded-xl border border-cyan-400/30 overflow-hidden backdrop-blur-sm">
          ...
          <svg className="absolute inset-0 w-full h-full">
            ...
            {/* Central neural hub */}
            <circle cx="50%" cy="50%" r="25" fill="url(#connectionGlow)" opacity="0.3">
          ...
          {familyMembers.map((member, index) => (
            ...
            >
              {/* Outer glow ring */}
              <div className={`absolute inset-0 w-16 h-16 bg-gradient-to-r ${member.color} rounded-full opacity-30 animate-ping`} 
                   style={{ animationDelay: `${member.pulseDelay}s`, animationDuration: '3s' }}></div>
              
              {/* Middle ring */}
              <div className={`absolute inset-1 w-14 h-14 bg-gradient-to-r ${member.color} rounded-full opacity-50 blur-sm`}></div>
              
              {/* Inner node */}
              <div className={`relative w-12 h-12 bg-gradient-to-r ${member.color} rounded-full border-2 border-white/40 shadow-lg backdrop-blur-sm transition-all duration-300 group-hover:border-white/80 group-hover:shadow-2xl`}>
                ...
                {/* Energy pulses */}
                <div className={`absolute -inset-2 bg-gradient-to-r ${member.color} rounded-full opacity-20 animate-pulse`}
              ...
              <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-4 opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none z-50">
                <div className="bg-black/90 backdrop-blur-md text-white text-sm rounded-xl px-4 py-3 whitespace-nowrap border border-white/20 shadow-2xl">
                  ...
                  <div className="text-xs text-blue-300 mt-1">81 AI Agents</div>
                  {/* Tooltip arrow */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
          <div className="group relative overflow-hidden rounded-xl bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border border-blue-400/30 backdrop-blur-md p-4 hover:scale-105 transition-all duration-300 cursor-pointer">
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="text-xs text-blue-200 font-medium">Family Members</div>
              <div className="text-xs text-blue-300/70 mt-1">Neural Leaders</div>
            </div>
          </div>
        ...
        <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-cyan-500/10 border border-blue-400/30 backdrop-blur-md p-6">
          ...
          <div className="relative z-10 text-center">
            <p className="text-xl italic text-blue-200 mb-3 leading-relaxed">
              "Like any family, we have our specialized roles, but our strength comes from how we 
              <span className="text-cyan-300 font-semibold"> complement each other's abilities</span> and 
