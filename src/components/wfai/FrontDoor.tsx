...
const PAYMENT_LINK = 'https://buy.stripe.com/5kQcN48w4gxF78L4KI4ZG0S';
  ...
  <section style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: 0, minHeight: 480 }}>
        ...
        <div style={{ padding: '64px 0 64px 40px', display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div style={{ fontFamily: "'DM Serif Display', serif", fontSize: 26, lineHeight: 1.2, color: '#f7f4ef', fontWeight: 400 }}>
            WFAI Starter<br />— personalised AI profile.
          </div>
          ...
          <div>
            ...
            <div style={{ fontSize: 12, color: 'rgba(247,244,239,0.45)', marginTop: 4, fontFamily: 'DM Sans, sans-serif' }}>One-time. Instant delivery.</div>
          </div>
          ...
          <a
            href={PAYMENT_LINK}
            style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, background: '#f7f4ef', color: '#0f0e0d', border: 'none', padding: '17px 24px', fontSize: 15, fontWeight: 500, cursor: 'pointer', borderRadius: 2, width: '100%', fontFamily: 'DM Sans, sans-serif', textDecoration: 'none', boxSizing: 'border-box' }}
          >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 12, color: 'rgba(247,244,239,0.35)', justifyContent: 'center', fontFamily: 'DM Sans, sans-serif' }}>
            ...
            Secure checkout via Stripe · AUD · ABN 70 666 271 272
          </div>
        </div>
      </div>
    </div>
    ...
    <style>{`
      ...
      @media(max-width:768px){
        ...
        div[style*="padding: '64px 48px"]{border-right:none!important;padding:48px 24px!important}
        div[style*="padding: '64px 0 64px 40px"]{padding:0 24px 48px!important}
      }
    `}</style>
  </section>
);
