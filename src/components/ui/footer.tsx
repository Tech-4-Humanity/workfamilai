...
export const Footer = () => {
  ...
  const platformFeatures = [
    {
      title: 'Neural Family Network',
      description: 'Interactive visualization of 9 AI family members with unique specializations',
      icon: Brain,
      action: () => navigate('/'),
      badge: '9 Leaders'
    },
    {
      ...
      description: 'Deep dive into each leader\'s domain with specialized agent teams and divisions',
      icon: Users,
      action: () => navigate('/'),
      badge: '729 Agents'
    },
    {
      ...
      description: 'Real-world process visualizations showing family collaboration patterns',
      icon: BarChart3,
      action: () => navigate('/scenarios'),
      badge: 'Live Processes'
    },
    {
      title: 'Holo-Org Dashboard',
      description: 'Organizational intelligence and partnership network management',
      icon: Building,
      action: () => navigate('/holo-org'),
      badge: 'Enterprise'
    },
    {
      title: 'Admin Controls',
      description: 'System management, agent integration, and consciousness pyramid',
      icon: Settings,
  ...
  const keyStats = [
    { label: 'Family Leaders', value: '9', description: 'Distinct personalities & domains', icon: Crown },
    { label: 'AI Agents', value: '729', description: 'Specialized capabilities', icon: Target },
    { label: 'Total Capabilities', value: '10K+', description: 'Organizational functions', icon: Zap },
    { label: 'Neural Activity', value: '24/7', description: 'Continuous collaboration', icon: Brain }
  ];
              ...
              return (
                <Card key={index} className="hover:shadow-lg transition-shadow cursor-pointer group" onClick={feature.action}>
                  <CardHeader className="pb-3">
                    ...
                    <CardTitle className="text-lg group-hover:text-blue-700">{feature.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {keyStats.map((stat, index) => {
              ...
              return (
                <div key={index} className="text-center p-6 bg-white rounded-lg border hover:border-blue-300 transition-colors">
